#ifndef MYSTACKH_CPP_INCLUDED
#define MYSTACKH_CPP_INCLUDED
...
class Stack {
    ...
    public:
        ...
        {
            if (topLevel >= NMAX-1) //starts from 0!!!! check if the stack array has the maximum dimension
			{
        ...
        T pop() // extracts and element from the stack array and returns the new top
        {
            ...
            return stackArray[topLevel--]; 	// returns the deleted top!!!! the topLevel decreases and the new top is changed
